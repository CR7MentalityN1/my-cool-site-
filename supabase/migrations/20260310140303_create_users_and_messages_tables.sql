/*
  # Create Платформа междисциплинарных проектов Database Schema

  ## Overview
  This migration creates the core tables for the Платформа междисциплинарных проектов platform - a student project collaboration platform.
