			...
			<div className='max-w-7xl mx-auto px-4 py-16'>
				<div className='text-center mb-16'>
					...
					<p className='text-lg text-gray-600 mb-12 max-w-2xl mx-auto'>
						Платформа для поиска единомышленников среди студентов университета.
						Создавайте проекты, делитесь идеями и находите партнеров для
						совместной работы.
					</p>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-20'>
					<div className='bg-white rounded-lg shadow-xl p-8 text-center hover:shadow-2xl transition'>
						...
						<p className='text-gray-600'>
							Просматривай профили студентов из разных факультетов и находи тех,
							кто разделяет твои интересы
						</p>
					</div>
					...
					<div className='bg-white rounded-lg shadow-xl p-8 text-center hover:shadow-2xl transition'>
						...
						<p className='text-gray-600'>
							Опиши свою идею проекта, укажи нужные навыки и жди откликов от
					...
					<div className='bg-white rounded-lg shadow-xl p-8 text-center hover:shadow-2xl transition'>
						...
						<p className='text-gray-600'>
							Используй общий чат для обсуждения идей и координации работы над
							проектами
						</p>
					</div>
				</div>
				...
				<div className='mt-20 bg-white rounded-lg shadow-xl p-12 text-center'>
					...
					<p className='text-gray-600 mb-8 text-lg'>
						Зарегистрируйся сейчас и найди свою идеальную команду для следующего
						проекта
					</p>
					<button
						onClick={onGetStarted}
